        ...
        <div class="row text-center text-white">
            ...
            <div class="col-md-3 col-6 mb-4">
                <div class="spec_1i p-4 bg-white/10 rounded">
                    ...
                    <h2>{{ $userCount }}</h2>
                    <h6>
                        <a href="{{ route('admin.staffs.index') }}" class="text-white text-decoration-none">
                            Người dùng
                        </a>
                    </h6>
                </div>
            ...
            <div class="col-md-3 col-6 mb-4">
                <div class="spec_1i p-4 bg-white/10 rounded">
                    ...
                    <h2>{{ $movieCount }}</h2>
                    <h6>
                        <a href="{{ route('admin.movies.index') }}" class="text-white text-decoration-none">
                            Phim hiện có
                        </a>
                    </h6>
                </div>
            ...
            <div class="col-md-3 col-6 mb-4">
                <div class="spec_1i p-4 bg-white/10 rounded">
                    ...
                    <h6>
                        <span class="text-white">Tổng doanh thu</span>
                    </h6>
                </div>
            </div>
