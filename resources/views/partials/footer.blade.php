...
<div class="footer_m clearfix">
 <div class="container">
   <div class="row footer_1">
    <div class="col-md-4">
	 <div class="footer_1i">
	   <h3><a class="text-white" href="{{ url('/') }}"><i class="fa fa-video-camera col_red me-1"></i> Q&HCinema</a></h3>
	   <p class="mt-3">© {{ date('Y') }} Rạp Chiếu Phim Q&H | Developed by 
        <strong>Nguyễn Mạnh Quyền</strong> & <strong>Phạm Văn Hoàng</strong> 🎥</p>
	   <h6 class="fw-normal"><i class="fa fa-map-marker fs-5 align-middle col_red me-1"></i>Đại Học Phenikaa,Yên Nghĩa, Hà Đông</h6>
        <h6 class="fw-normal mt-3"><i class="fa fa-envelope fs-5 align-middle col_red me-1"></i>23010245@st.phenikaa-uni.edu.vn</h6>
		<h6 class="fw-normal mt-3 mb-0"><i class="fa fa-phone fs-5 align-middle col_red me-1"></i>+84 9856 193 47</h6>
	 </div>
	</div>
	<div class="col-md-4">
	 <div class="footer_1i">
