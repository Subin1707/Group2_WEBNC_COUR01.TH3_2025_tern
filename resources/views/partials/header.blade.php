                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                        ...
                        @if (Auth::user()->role === 'admin')
                            ...
                            <li class="nav-item"><a class="nav-link text-warning" href="{{ route('support.admin.dashboard') }}">🆘 CSKH</a></li>
                        ...
                        @else
                            ...
                            <li class="nav-item"><a class="nav-link text-warning" href="{{ route('support.index') }}">🆘 Hỗ trợ</a></li>
                        @endif
